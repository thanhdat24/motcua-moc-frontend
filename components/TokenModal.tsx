      ...
      <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl max-w-lg w-full p-8 animate-scale-in transition-colors duration-200 border border-gray-100 dark:border-gray-700">
        ...
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            <div
              className={`p-2.5 bg-${accentColor}-500 dark:bg-${accentColor}-600 rounded-xl shadow-lg shadow-${accentColor}-200 dark:shadow-none text-white`}
            >
            ...
            <div>
              ...
              <p
                className={`text-xs text-${accentColor}-600 dark:text-${accentColor}-400 font-bold uppercase tracking-wider`}
              >
        ...
        <div className="space-y-4">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg">
            <p className="text-[10px] text-blue-700 dark:text-blue-300 leading-relaxed font-medium">
              <span className="font-bold underline uppercase">Cách lấy:</span>{" "}
              Mở trang DVC {ministryName} → F12 → Tab Network → Gõ "search" →
              Click 1 request → Copy giá trị "Authorization" trong Request
              Headers.
            </p>
          </div>
        </div>
